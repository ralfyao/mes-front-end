                    ...
                    <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                        <q-popup-proxy cover v-model="showDatePopup" transition-show="scale" transition-hide="scale">
                          <q-date v-close-popup @update:model-value="showDatePopup = false" v-model="props.row.日期" :readonly="readonly||preview" mask="YYYY/MM/DD" no-title>
                    ...
                    <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                        <q-popup-proxy cover v-model="showReqDatePopup" transition-show="scale" transition-hide="scale">
                          <q-date v-close-popup v-model="props.row.需求日期"  @update:model-value="showReqDatePopup = false" :readonly="readonly||preview" mask="YYYY/MM/DD" no-title>
                            <div class="row items-center justify-end">
